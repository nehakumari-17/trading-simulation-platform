...
# this is about 0.1% of trade value

TRANSACTION_COST_RATE = 0.001   #0.1%
SLIPPAGE_RATE         = 0.0005  #0.05% — market orders slips a little
...
async def place_order(
    ...
    pnl = 0.0  #  it will be calculated properly on SELL orders below
